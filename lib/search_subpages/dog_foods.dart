...
class Dogfoods extends StatefulWidget {
  ...
  @override
  State<Dogfoods> createState() => _DogfoodsState();
}

class _DogfoodsState extends State<Dogfoods> {
  ...
  fetchAddvertisments() async {
    ...
    QuerySnapshot qn =
    await _firestoreInstance.collection("addvertisments").where('addCategories', isEqualTo: 'Dog foods').get();
    setState(() {
