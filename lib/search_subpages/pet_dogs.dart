...
class Petdogs extends StatefulWidget {
  const Petdogs({Key? key}) : super(key: key);

  @override
  State<Petdogs> createState() => _PetdogsState();
}

class _PetdogsState extends State<Petdogs> {
  ...
  fetchAddvertisments() async {
    ...
    QuerySnapshot qn =
    await _firestoreInstance.collection("addvertisments").where('addCategories', isEqualTo: 'Pet dogs').get();
    setState(() {
